    ...
    <section className='AboutSection-content Section-content' ref={sectionRef}  id="AboutSection-content">
      ...
      <div className="inner">
        <div className="about-content">
          ...
          <p>At present, my primary focus revolves around the development of accessible and inclusive products, coupled with the crafting of captivating digital experiences. This mission holds utmost importance to me, and I am dedicated to pursuing it not only within the innovative ecosystem of  <span className='highlights'>Yelow and Sayf</span> but also through a diverse array of personal pet projects. By prioritizing inclusivity and fostering a collaborative atmosphere, I aim to leave a positive impact on the world of technology and beyond.</p>
